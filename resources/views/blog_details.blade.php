...
<body>
        ...
        <div class="container-fluid" style="padding:20px 0px;">
            <div class="row d-flex" style="border-bottom: 1px solid black;">
                <div class="col-md-4 logo float-left pl-5">
                    <h1 class="text-light pt-1"><a href="{{ route('home') }}"><span><img src="{{asset('assets/images/logo.png')}}" alt="" class="img-fluid"></span></a></h1>
                    <!-- Uncomment below if you prefer to use an image logo -->
                    <!-- <a href="index.html"><img src="assets/img/logo.png" alt="" class="img-fluid"></a> -->
                </div>

                <div class="col-md-4 text-center blog-title">
                    <img src="{{ asset('assets/images/coins/BTC.png') }}" class="img-coin" alt="">
                    <img src="{{ asset('assets/images/coins/ETC.png') }}" class="img-coin" alt="">
                    <img src="{{ asset('assets/images/coins/LTC.png') }}" class="img-coin" alt="">
                    <img src="{{ asset('assets/images/coins/XRP.png') }}" class="img-coin" alt="">
                    <img src="{{ asset('assets/images/coins/ZEC.png') }}" class="img-coin" alt="">
                </div>
    ...
    <content>
        <section class="custom-border pt-0">
            <div class="container">
                <div class="row pt-2" data-aos="fade-up" data-aos-delay="100">
                    <div class="col-md-9 blog-detail-main pr-4">
                        <h1 class="entry-title-detail">Hello, World! Introducing CEX.IO Broker</h1>
                    ...
                    <div class="col-md-3 pl-4 pt-5">
                        <div class="et_pb_widget widget_text"> 
                            <div class="textwidget">
                                <a href="{{ route('home') }}">
                                    <img src="https://cex.io/widget/light/240/btc-usd" width="240" height="120">
                                </a>
                            </div>
                        </div>
                        <div class="widget_text et_pb_widget widget_custom_html">
                            <div class="textwidget custom-html-widget">
                                <a href="{{ route('home') }}">
                                <img class="image-container-detail pl-0 pt-5" src="https://blog.cex.io/wp-content/uploads/2017/12/cex-io-buy-bitcoins-with-your-credit-card-eng-1.png" alt="Buy bitcoins with credit card on cex.io"></a>
                            </div>
                        </div>
                        <div class="widgettitle pt-5"> 
                            <h4>Recent Posts</h4> 
                            <ul>
                                <li>
                                <a href="https://blog.cex.io/news/cex-io-introduces-unlimited-max-order-size-for-large-traders-21250">CEX.IO introduces unlimited max order size for large traders and market makers</a>
                                </li>
                                <li>
                                <a href="https://blog.cex.io/cryptonews/blockchain-events-to-visit-in-autumn-2020-21225">Blockchain events to visit in Autumn 2020</a>
                                </li>
                                <li>
                                <a href="https://blog.cex.io/news/cex-io-partners-with-p2p-validator-to-provide-cosmos-and-tezos-staking-21187">CEX.IO Partners with P2P Validator to Provide Cosmos and Tezos Staking</a>
                                </li>
                                <li>
                                <a href="https://blog.cex.io/news/cex-io-to-list-link-21193">CEX.IO to list Chainlink (LINK)</a>
                                </li>
                                <li>
                                <a href="https://blog.cex.io/cryptonews/blockchain-events-in-summer-2020-21089">Blockchain events in summer 2020</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row d-flex justify-content-center pb-5" data-aos="fade-up" data-aos-delay="100">
                    <a class="triangle-container" href="{{ route('blog') }}">
                        <div class="triangle-left"></div>
                        <div class="rect">Back</div>
                    </a>
                    <a class="btn btn-info btn-explore-new" href="{{route('home')}}">Start Trading</a>
                </div>
                <div class="row d-flex justify-content-center pb-5" data-aos="fade-up" data-aos-delay="100">
