<ul id="menu" class="page-sidebar-menu">
    <li {!! (Request::is('admin') ? 'class="active"' : '') !!}>
        <a href="{{ route('admin.dashboard') }}">
            <i class="livicon" data-name="list" data-size="18" data-c="#418BCA" data-hc="#418BCA"
               data-loop="true"></i>
            General Report
        </a>
    </li>
    <li {!! (Request::is('admin/comparison_report') ? 'class="active"' : '') !!}>
        <a href="{{ URL::to('admin/comparison_report') }}">
            <i class="livicon" data-name="linechart" data-size="18" data-c="#418BCA" data-hc="#418BCA"
               data-loop="true"></i>
            <span class="title">Comparison Report</span>
        </a>
    </li>
    <li {!! (Request::is('admin/facebook_report') ? 'class="active"' : '') !!}>
        <a href="{{ URL::to('admin/facebook_report') }}">
            <i class="livicon" data-name="facebook-alt" data-size="18" data-c="#418BCA" data-hc="#418BCA"
               data-loop="true"></i>
            <span class="title">Facebook Report</span>
        </a>
    </li>
    <li {!! (Request::is('admin/taboola_report') ? 'class="active"' : '') !!}>
        <a href="{{ URL::to('admin/taboola_report') }}">
            <i class="livicon" data-name="tumblr" data-size="18" data-c="#418BCA" data-hc="#418BCA"
               data-loop="true"></i>
            <span class="title">Taboola Report</span>
        </a>
    </li>
