        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    ...
                    <div class="card-body">
                        <form action="{{ URL::to('admin/destinations/update').'/'.$data->id }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="dest_name" name="dest_name" class="form-control" placeholder="Christ the Redeemer" value="{{$data->name}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-2 offset-md-1">
                                        ...
                                        @if($data->photo_urls)
                                            <input type="file" id="input-file-now" name="dest_photo1" class="dropify" data-max-file-size="2M" accept="image/x-png,image/gif,image/jpeg" data-default-file="{{asset('uploads/files/destinations/'.$data->id.'/1.png')}}"/>
                                        @else
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        @if($data->photo_urls)
                                            <input type="file" id="input-file-now" name="dest_photo2" class="dropify" data-max-file-size="2M" accept="image/x-png,image/gif,image/jpeg" data-default-file="{{asset('uploads/files/destinations/'.$data->id.'/2.png')}}"/>
                                        @else
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        @if($data->photo_urls)
                                            <input type="file" id="input-file-now" name="dest_photo3" class="dropify" data-max-file-size="2M" accept="image/x-png,image/gif,image/jpeg" data-default-file="{{asset('uploads/files/destinations/'.$data->id.'/3.png')}}"/>
                                        @else
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        @if($data->photo_urls)
                                            <input type="file" id="input-file-now" name="dest_photo4" class="dropify" data-max-file-size="2M" accept="image/x-png,image/gif,image/jpeg" data-default-file="{{asset('uploads/files/destinations/'.$data->id.'/4.png')}}"/>
                                        @else
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        @if($data->photo_urls)
                                            <input type="file" id="input-file-now" name="dest_photo5" class="dropify" data-max-file-size="2M" accept="image/x-png,image/gif,image/jpeg" data-default-file="{{asset('uploads/files/destinations/'.$data->id.'/5.png')}}"/>
                                        @else
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="3" name="about_dest" class="form-control form-control-line" required>{{$data->about_dest}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="3" name="about_weather" class="form-control form-control-line" required>{{$data->about_weather}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="3" name="about_costofliving" class="form-control form-control-line" required>{{$data->about_costofliving}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="3" maxlength="200" name="search_result_description" class="form-control form-control-line" required>{{$data->search_result_description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="attr_1_name" id="name" class="form-control" placeholder="" value="{{$data->attr_1_name}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="3" maxlength="200" name="attr_1_about" class="form-control form-control-line" required>{{$data->attr_1_about}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="attr_2_name" id="name" class="form-control" placeholder="" value="{{$data->attr_2_name}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="3" maxlength="200" name="attr_2_about" class="form-control form-control-line" required>{{$data->attr_2_about}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="attr_3_name" id="name" class="form-control" placeholder="" value="{{$data->attr_3_name}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="3" maxlength="200" name="attr_3_about" class="form-control form-control-line" required>{{$data->attr_3_about}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="attr_4_name" id="name" class="form-control" placeholder="" value="{{$data->attr_4_name}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="3" maxlength="200" name="attr_4_about" class="form-control form-control-line" required>{{$data->attr_4_about}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="attr_5_name" id="name" class="form-control" placeholder="" value="{{$data->attr_5_name}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="3" maxlength="200" name="attr_5_about" class="form-control form-control-line" required>{{$data->attr_5_about}}</textarea>
                                        </div>
                                    </div>
                                </div>                
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input name="country" id="searchTextField" placeholder="Enter a country" autocomplete="off" class="form-control" value="{{$data->country}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
