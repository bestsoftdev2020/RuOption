                                    ...
                                    <div class="mr-auto">
                                        <div class="form-group">
                                            <a href="{{ URL::to('admin/products/create') }}">
                                                ...
                                                <button class="btn btn-info btn-block btn-sm"><i class="icon wb-plus" aria-hidden="true"></i>Add New Product
                                                </button>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <tbody>
                                @if($datas)
                                    @foreach($datas as $data)
                                        <tr>
                                            <td><a href="{{ URL::to('admin/products/'.$data->id.'/edit') }}">{{$data->name}}</a></td>
                                            ...
                                            <td>{{$data->price_12}}</td>
                                            <td>
                                                <a href="{{ URL::to('admin/products/delete').'/'.$data->id }}"><button type="button" class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn"><i class="fa fa-bitbucket" style="font-size: 1.5em;" aria-hidden="true"></i></button></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @else
